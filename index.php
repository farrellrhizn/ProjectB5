        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <form class="d-flex" class="ms-auto my-4 my-lg-0" action="" method="POST">
                ...
                <button type="button" name="submit" value="cari" class="btn btn-light"><i class="fa-solid fa-magnifying-glass"></i></button>
            </form>
        ...
        <div class="row text-center row-container mt-2">
            <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="menu-kategori">
                    <a href=""><img src="img/kategori/fast-food.png" class="img-categori mt-3"></a>
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="menu-kategori">
                    <a href=""><img src="img/kategori/soft_drink.png" class="img-categori mt-3"></a>
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="menu-kategori">
                    <a href=""><img src="img/kategori/snack.png" class="img-categori mt-3"></a>
                    <p class="mt-2">Makanan Ringan</p>
                </div>
            </div>

            <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="menu-kategori">
                    <a href=""><img src="img/kategori/pencil.png" class="img-categori mt-3"></a>
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="menu-kategori">
                    <a href=""><img src="img/kategori/spice.png" class="img-categori mt-3"></a>
                    <p class="mt-2">Bumbu Dapur</p>
                </div>
            </div>

            <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="menu-kategori">
                    <a href=""><img src="img/kategori/bath.png" class="img-categori mt-3"></a>
                    <p class="mt-2">Perlengkapan Mandi</p>
                </div>
            </div>

            <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="menu-kategori">
                    <a href=""><img src="img/kategori/equipment.png" class="img-categori mt-3"></a>
                    <p class="mt-2">Perlengkapan Mencuci</p>
                </div>
            </div>

            <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="menu-kategori">
                    <a name="sembako" href=""><img src="img/kategori/food.png" class="img-categori mt-3"
                    value=""></a>
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="menu-kategori">
                    <a href=""><img src="img/kategori/sapu.png" class="img-categori mt-3"></a>
                    <p class="mt-2">Peralatan Rumah Tangga</p>
                </div>
            </div>
        </div>
      </div>
